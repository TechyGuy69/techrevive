...
export default function ServicesPage() {
  return (
    <div className="bg-slate-50 min-h-screen pb-12 md:pb-24">
      {/* Header */}
      <section className="relative bg-white py-12 md:py-20 overflow-hidden border-b">
      ...
      <div className="container mx-auto px-4 md:px-6 mt-10 md:mt-12">
        ...
        {/* Process/Guarantee */}
        <section className="mt-8 md:mt-16 rounded-[2rem] md:rounded-[3rem] bg-white border border-slate-200 p-8 md:p-16 shadow-xl relative overflow-hidden">
          ...
          <div className="grid gap-8 md:gap-12 lg:grid-cols-2 relative z-10">
            ...
            <div className="flex flex-col justify-center items-center text-center p-8 md:p-12 rounded-[1.5rem] md:rounded-[2rem] tech-gradient text-white shadow-2xl">
