  ...
  if (submitted) {
    return (
      <div className="min-h-[70vh] flex items-center justify-center p-4">
        <Card className="max-w-md w-full rounded-[2.5rem] border-none shadow-2xl overflow-hidden animate-fade-in-up">
          <CardContent className="p-12 text-center space-y-6">
            <div className="mx-auto h-20 w-20 rounded-full bg-green-100 text-green-600 flex items-center justify-center">
              <CheckCircle2 className="h-10 w-10" />
            </div>
            <div className="space-y-2">
              <h2 className="text-3xl font-bold">Thank You!</h2>
              <p className="text-muted-foreground">Your service request has been received. Usnish Banerjee will reach out to you within 30 minutes.</p>
            </div>
    ...
    <div className="bg-slate-50 pt-16 pb-24">
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="grid gap-12 lg:grid-cols-2">
          ...
          <div className="space-y-8 md:space-y-10">
            ...
            <div className="space-y-4 md:space-y-6">
              <a 
                ...
                className="flex items-start gap-4 p-5 md:p-6 rounded-3xl bg-white shadow-sm border border-slate-100 hover:border-primary/20 hover:shadow-md transition-all group"
              >
              ...
              <div className="flex items-start gap-4 p-5 md:p-6 rounded-3xl bg-white shadow-sm border border-slate-100">
            ...
            {/* Google Map Embed */}
            <div className="overflow-hidden rounded-3xl border border-slate-200 shadow-lg h-[250px] md:h-[300px]">
              <iframe
          ...
          {/* Contact Form */}
          <div className="rounded-[2.5rem] bg-white p-6 md:p-10 shadow-2xl border border-slate-100 h-fit lg:sticky lg:top-24">
            <div className="mb-8">
            ...
            <div className="mt-8 pt-8 border-t text-center space-y-4">
              ...
              <div className="flex justify-center gap-6">
                <a href="tel:9593088017" className="flex h-14 w-14 items-center justify-center rounded-full bg-blue-50 text-primary hover:bg-primary hover:text-white transition-all shadow-sm">
                  <PhoneCall className="h-6 w-6" />
                </a>
                <a href="https://wa.me/919593088017" className="flex h-14 w-14 items-center justify-center rounded-full bg-green-50 text-green-600 hover:bg-green-600 hover:text-white transition-all shadow-sm">
                  <MessageCircle className="h-6 w-6" />
                </a>
              </div>
            </div>
