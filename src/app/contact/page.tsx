          ...
          <div className="space-y-10">
            ...
            <div className="space-y-6">
              <a 
                ...
                className="flex items-start gap-4 p-6 rounded-3xl bg-white shadow-sm border border-slate-100 hover:border-primary/20 hover:shadow-md transition-all group"
              >
